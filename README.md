...
- Trackpad only laptops with no mouse attached controlling a remote mac via push through edge must use the keyboard hotkeys, as the touchpad eats the shake detection inputs for the host mac  
